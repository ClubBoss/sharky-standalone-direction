...
void main() {
  ...
  test(
    'isCampaignWorldDoneByCompletedSetV1 accepts any surfaced world2 followup branch',
    () {
      expect(
  ...
  test(
    'campaign rank counts world2 completion from any surfaced followup branch',
    () async {
      SharedPreferences.setMockInitialValues(<String, Object>{
  ...
  test(
    'campaign complete delegates world1 completion to canonical helper',
    () async {
      SharedPreferences.setMockInitialValues(<String, Object>{
        'spine_campaign_completed_packs_v1':
