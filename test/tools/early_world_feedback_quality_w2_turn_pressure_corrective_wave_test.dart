...
void main() {
  test(
    'w2 turn-pressure trio keeps corrective misses distinct and action-guiding',
    () {
      final repoRoot = Directory.current.path;
      final expectations = <String, List<String>>{
        'content/worlds/world2/v1/sessions/w2.s07/drills/d.choose_call_facing_turn_bet.json': <String>[
          'Folding gives up too much',
          'raising overstates',
        ],
        'content/worlds/world2/v1/sessions/w2.s07/drills/d.choose_fold_facing_turn_bet.json': <String>[
          'Calling pays too much',
          'should simply release',
        ],
        'content/worlds/world2/v1/sessions/w2.s07/drills/d.choose_raise_facing_turn_pressure.json': <String>[
          'raising back now',
          'absorbs pressure',
          'fold equity',
        ],
      ...
      for (final entry in expectations.entries) {
        ...
        expect(
          ...
          reason: '${entry.key} incorrect feedback should not duplicate the positive line.',
        );
        ...
        for (final banned in bannedPhrases) {
          expect(
            ...
            reason: '${entry.key} should avoid weak branch-like corrective wording.',
          );
        }
      }
    },
