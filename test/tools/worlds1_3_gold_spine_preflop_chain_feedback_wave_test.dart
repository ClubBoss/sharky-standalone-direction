    ...
    () {
      ...
      final expectations = <String, Map<int, List<String>>>{
        ...
        'content/worlds/world2/v1/sessions/w2.s09/drills/d.chain_position_initiative_texture_v1.json':
            <int, List<String>>{
              ...
              2: <String>[
                'Jh Th 9c',
                'straight and flush pressure',
                'pressure-building action',
              ],
            },
        ...
        'content/worlds/world3/v1/sessions/w3.s01/drills/d.chain_preflop_framework_intro_v1.json':
            <int, List<String>>{
              ...
              1: <String>[
                'QJs',
                'button',
                'calling keeps a playable hand in position',
              ],
        ...
        'content/worlds/world3/v1/sessions/w3.s06/drills/d.chain_preflop_mixed_context_checkpoint_v1.json':
            <int, List<String>>{
        ...
        'content/worlds/world3/v1/sessions/w3.s07/drills/d.chain_preflop_open_fold_position_v1.json':
            <int, List<String>>{
              0: <String>['KJo', 'late-position value', 'blinds act'],
              1: <String>[
                'KJo',
                'more players remain behind',
                'earlier position',
              ],
        ...
        'content/worlds/world3/v1/sessions/w3.s08/drills/d.chain_preflop_continue_fold_discipline_v1.json':
            <int, List<String>>{
              0: <String>[
                'QTs',
                'playable in-position continue',
                'giving up too much equity',
              ],
              1: <String>['K9o', 'big blind', 'dominated strength'],
              2: <String>[
                'AJs',
                'continue against a cutoff open',
                'needlessly inflating the pot',
              ],
            },
      ...
      for (final fileEntry in expectations.entries) {
        ...
        for (final stepEntry in fileEntry.value.entries) {
          final feedback =
              (steps[stepEntry.key]
                      as Map<String, dynamic>)['feedback_incorrect_v1']
                  as String;
          ...
          for (final snippet in stepEntry.value) {
            expect(
              ...
              contains(snippet),
              reason:
                  '${fileEntry.key} step ${stepEntry.key + 1} should teach the poker reason explicitly.',
            );
          }
          for (final banned in bannedPhrases) {
            expect(
              ...
              reason:
                  '${fileEntry.key} step ${stepEntry.key + 1} should not regress to abstract template wording.',
            );
          }
        }
      }
