...
void main() {
  ...
  test(
    'reports W3 canonical PR2 and canonical aggregate as route-ready coverage',
    () {
      final pr2Result = validateContentSchemaL2L3FixturePathsV1([
        'test/fixtures/content_factory_mvp/'
            'w3_hand_bucket_action_frame_canonical_pr2_v1.json',
      ]);

      expect(pr2Result.errors, isEmpty);
      expect(pr2Result.routeAdmissionErrors, isEmpty);
      expect(pr2Result.warnings, isEmpty);

      final pr2World = pr2Result.worldReports['world_3']!;
      expect(pr2World.totalTasks, 6);
      expect(pr2World.coverageCountableTasks, 6);
      expect(
        pr2World.conceptFamilyCounts['hand_bucket_action_frame_discipline'],
        6,
      );
      expect(
        pr2World
            .sameSignalGroupCounts['w3.position_thinking.hand_bucket_action_frame'],
        6,
      );
      expect(
        pr2World.repairFocusCounts['hand_bucket_before_preflop_action'],
        6,
      );
      expect(pr2World.sourceTruthStatusCounts['migrated'], 6);
      expect(pr2World.coverageReady, true);
      expect(pr2World.transferReady, true);
      expect(pr2World.repairReady, true);
      expect(pr2World.routeAdmissionStatus, 'learner_playable_route_ready');

      final canonicalResult = validateContentSchemaL2L3FixturePathsV1([
        'test/fixtures/content_factory_mvp/'
            'w3_canonical_certification_pilot_v1.json',
        'test/fixtures/content_factory_mvp/'
            'w3_hand_bucket_action_frame_canonical_pr2_v1.json',
      ...
      expect(canonicalResult.errors, isEmpty);
      expect(canonicalResult.routeAdmissionErrors, isEmpty);
      expect(canonicalResult.warnings, isEmpty);

      final canonicalWorld = canonicalResult.worldReports['world_3']!;
      expect(canonicalWorld.totalTasks, 12);
      expect(canonicalWorld.coverageCountableTasks, 12);
      expect(canonicalWorld.sourceTruthStatusCounts['migrated'], 12);
      expect(canonicalWorld.coverageReady, true);
      expect(canonicalWorld.transferReady, true);
      expect(canonicalWorld.repairReady, true);
      expect(
        canonicalWorld.routeAdmissionStatus,
        'learner_playable_route_ready',
      );
    },
  );

  test('keeps W3 bridge plus both canonical fixtures bridge-limited', () {
    final result = validateContentSchemaL2L3FixturePathsV1([
      'test/fixtures/content_factory_mvp/'
          'w3_bridge_or_legacy_schema_migration_pilot_v1.json',
      'test/fixtures/content_factory_mvp/'
  ...
  test('reports W6 range bucket canonical pilot as route-ready coverage', () {
    final result = validateContentSchemaL2L3FixturePathsV1([
      'test/fixtures/content_factory_mvp/'
    ...
    expect(world.transferSurfaceCounts['made_hand_clean_fit_v1'], 2);
    expect(world.transferSurfaceCounts['made_hand_showdown_fit_v1'], 1);
    expect(world.transferSurfaceCounts['light_pair_fit_v1'], 1);
    expect(world.transferSurfaceCounts['missed_no_clear_draw_v1'], 2);
  ...
  test('keeps W6 bridge plus canonical pilot bridge-limited', () {
    final result = validateContentSchemaL2L3FixturePathsV1([
      'test/fixtures/content_factory_mvp/'
          'w6_bridge_or_legacy_schema_migration_pilot_v1.json',
      'test/fixtures/content_factory_mvp/'
  ...
  test('reports W4 canonical PR2 as route-ready coverage', () {
    final result = validateContentSchemaL2L3FixturePathsV1([
      'test/fixtures/content_factory_mvp/'
    ...
    expect(world.totalTasks, 6);
    expect(world.coverageCountableTasks, 6);
    expect(world.conceptFamilyCounts['intent_action_discipline'], 6);
    expect(
      world
          .sameSignalGroupCounts['w4.bet_purpose_price.intent_action_discipline'],
      6,
    );
    expect(world.transferSurfaceCounts['protection_raise_action_v1'], 2);
    expect(world.transferSurfaceCounts['bluff_raise_action_v1'], 2);
    expect(world.transferSurfaceCounts['denial_raise_action_v1'], 1);
    expect(world.transferSurfaceCounts['denial_control_call_v1'], 1);
    expect(world.repairFocusCounts['purpose_before_action'], 6);
    expect(world.sourceTruthStatusCounts['migrated'], 6);
    expect(world.coverageReady, true);
    expect(world.transferReady, true);
    expect(world.repairReady, true);
  ...
  test('reports W5 canonical PR2 as route-ready coverage', () {
    final result = validateContentSchemaL2L3FixturePathsV1([
      'test/fixtures/content_factory_mvp/'
    ...
    expect(world.totalTasks, 6);
    expect(world.coverageCountableTasks, 6);
    expect(world.conceptFamilyCounts['board_shift_awareness'], 6);
    expect(
      world.sameSignalGroupCounts['w5.board_awareness.board_shift_awareness'],
      6,
    );
    expect(world.transferSurfaceCounts['turn_connected_pressure_v1'], 1);
    expect(world.transferSurfaceCounts['turn_wet_control_v1'], 1);
    expect(world.transferSurfaceCounts['turn_paired_release_v1'], 1);
    expect(world.transferSurfaceCounts['river_connected_control_v1'], 1);
    expect(world.transferSurfaceCounts['river_dry_missed_release_v1'], 1);
    expect(world.transferSurfaceCounts['river_wet_pressure_v1'], 1);
    expect(world.repairFocusCounts['board_shift_before_action'], 6);
    expect(world.sourceTruthStatusCounts['migrated'], 6);
    expect(world.coverageReady, true);
    expect(world.transferReady, true);
    expect(world.repairReady, true);
  ...
  test('reports W4-W5 canonical PR2 fixture list as route-ready by world', () {
    final result = validateContentSchemaL2L3FixturePathsV1(
    ...
    expect(result.routeAdmissionErrors, isEmpty);
    expect(result.warnings, isEmpty);
    expect(result.fixtureCount, w4W5CanonicalCoveragePr2FixturePathsV1.length);
  ...
  test('keeps W4 bridge plus canonical pilot and PR2 bridge-limited', () {
    final result = validateContentSchemaL2L3FixturePathsV1([
      'test/fixtures/content_factory_mvp/'
          'w4_bridge_or_legacy_schema_migration_pilot_v1.json',
      'test/fixtures/content_factory_mvp/'
  ...
  test('keeps W5 bridge plus canonical pilot and PR2 bridge-limited', () {
    final result = validateContentSchemaL2L3FixturePathsV1([
      'test/fixtures/content_factory_mvp/'
          'w5_bridge_or_legacy_schema_migration_pilot_v1.json',
      'test/fixtures/content_factory_mvp/'
