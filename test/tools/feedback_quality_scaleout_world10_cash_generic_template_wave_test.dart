...
void main() {
  test(
    'world10 cash generic-template wave stays poker-reasoned in cash.s01-cash.s05',
    () {
      ...
      expect(
        ...
        isEmpty,
        reason:
            'cash.s01-cash.s05 should no longer emit generic_template_feedback.',
      );
      ...
      for (final sessionId in admittedSessions) {
        final sessionDir = Directory(
          '$repoRoot/content/worlds/world10/v1/tracks/cash/sessions/$sessionId/drills',
        );
        final files =
            sessionDir
                .listSync()
