...
void main() {
  test('World 0 drill indexes use dealer button seat wording instead of dealer position', () {
  ...
  test('validator no longer reports World 0 dealer-position jargon failures', () async {
