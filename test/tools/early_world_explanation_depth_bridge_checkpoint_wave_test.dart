    ...
    () {
      ...
      final expectations = <String, Map<String, List<String>>>{
        ...
        'content/worlds/world2/v1/sessions/w2.s05/drills/d.review_initiative_hero_keeps_pressure.json': {
          ...
          'feedback_incorrect_v1': ['last aggressor preflop', 'pressure first'],
        },
        'content/worlds/world2/v1/sessions/w2.s09/drills/d.choose_call_bridge_showdown.json': {
          'why_v1': ['medium-strength hand', 'thin bluff'],
          'feedback_correct_v1': ['showdown often enough', 'turning it into a bluff'],
          'feedback_incorrect_v1': ['showdown often enough', 'cleaner than bluffing'],
        },
        'content/worlds/world2/v1/sessions/w2.s09/drills/d.choose_call_bridge_tocall_price_ok.json': {
          ...
          'feedback_correct_v1': ['price is manageable', 'stretching into a raise'],
          'feedback_incorrect_v1': ['manageable price', 'keeps the hand in play'],
        },
        'content/worlds/world2/v1/sessions/w2.s09/drills/d.choose_fold_bridge_pressure_release.json': {
          ...
          'feedback_correct_v1': ['run out of room', 'forcing more money in'],
          'feedback_incorrect_v1': ['run out of room', 'folding is cleaner'],
        },
        ...
        'content/worlds/world2/v1/sessions/w2.s09/drills/d.choose_raise_bridge_value.json': {
          ...
          'feedback_correct_v1': ['strong enough to bet now', 'passive line'],
          'feedback_incorrect_v1': ['strong enough to bet', 'gives up value'],
        },
        'content/worlds/world2/v1/sessions/w2.s10/drills/d.choose_call_checkpoint_showdown_branch.json': {
          ...
          'feedback_incorrect_v1': ['medium-strength hand', 'cheaper value path'],
        },
        'content/worlds/world2/v1/sessions/w2.s10/drills/d.choose_call_checkpoint_tocall_price_ok.json': {
          'why_v1': ['price is still manageable', 'forcing a bigger action'],
          'feedback_correct_v1': ['price is still acceptable', 'forcing a bigger action'],
          'feedback_incorrect_v1': ['price still acceptable', 'forcing a bigger action'],
        },
        'content/worlds/world2/v1/sessions/w2.s10/drills/d.choose_fold_checkpoint_tocall_price_bad.json': {
          ...
          'feedback_correct_v1': ['price gets too poor', 'paying off anyway'],
          'feedback_incorrect_v1': ['price gets too poor', 'release with a fold'],
        },
        'content/worlds/world2/v1/sessions/w2.s10/drills/d.choose_raise_checkpoint_value_branch.json': {
          ...
          'feedback_correct_v1': ['Position plus value', 'money-winning line'],
          'feedback_incorrect_v1': ['value-heavy', 'raising is the clearer line'],
        },
        'content/worlds/world3/v1/sessions/w3.s03/drills/d.choose_call_preflop_checkpoint_v1.json': {
          ...
          'feedback_correct_v1': ['cutoff open', 'without bloating the pot'],
          'feedback_incorrect_v1': ['in-position call', 'stronger opening ranges'],
        },
        'content/worlds/world3/v1/sessions/w3.s06/drills/d.choose_raise_mixed_context_checkpoint_v1.json': {
          ...
          'feedback_incorrect_v1': ['button with ATo', 'right compact action is to raise'],
        },
        'content/worlds/world3/v1/sessions/w3.s10/drills/d.choose_fold_final_preflop_checkpoint_v1.json': {
          ...
          'feedback_correct_v1': ['J8o in the cutoff', 'disciplined preflop play'],
          'feedback_incorrect_v1': ['J8o', 'disciplined compact action is to fold'],
        },
      ...
      for (final entry in expectations.entries) {
        ...
        expect(feedbackCorrect, isNotNull, reason: '${entry.key} should author positive feedback.');
        expect(feedbackIncorrect, isNotNull, reason: '${entry.key} should author corrective feedback.');
        expect(feedbackCorrect, isNot('Correct.'), reason: '${entry.key} should not use generic positive feedback.');
        expect(feedbackIncorrect, isNot('Incorrect.'), reason: '${entry.key} should not use generic corrective feedback.');
        ...
        for (final fieldEntry in entry.value.entries) {
          ...
          for (final banned in bannedPhrases) {
            expect(
              ...
              reason: '${entry.key} ${fieldEntry.key} should avoid internal curriculum labels.',
            );
          }
        }
      }
