...
void main() {
  ...
  test('World 0 learner copy uses seat/table wording instead of position phrasing', () {
    ...
    expect(
      File('content/worlds/world0/v1/sessions/index.md')
          .readAsStringSync()
          .toLowerCase()
          .contains('seat-layout checks'),
      isTrue,
    );
    expect(
      File('content/worlds/world0/v1/sessions/w0.s05/session.md')
          .readAsStringSync()
          .toLowerCase()
  ...
  test('validator no longer reports World 0 position-language failures', () async {
