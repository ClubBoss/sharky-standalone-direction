    ...
    () {
      ...
      final expectations = <String, Map<String, List<String>>>{
        'content/worlds/world2/v1/sessions/w2.s09/drills/d.choose_call_bridge_showdown.json': {
          ...
          'feedback_incorrect_v1': <String>['showdown value', 'cheaper value path'],
        },
        'content/worlds/world2/v1/sessions/w2.s09/drills/d.choose_call_bridge_tocall_price_ok.json': {
          ...
          'feedback_incorrect_v1': <String>['manageable continue price', 'extra aggression', 'cleaner line is to call'],
        },
        'content/worlds/world2/v1/sessions/w2.s09/drills/d.choose_fold_bridge_pressure_release.json': {
          ...
          'feedback_incorrect_v1': <String>['run out of room', 'cleaner release'],
        },
        'content/worlds/world2/v1/sessions/w2.s09/drills/d.choose_raise_bridge_pressure_counter.json': {
          ...
          'feedback_incorrect_v1': <String>['absorbs pressure', 'pushes back now', 'stronger counter'],
        },
        'content/worlds/world2/v1/sessions/w2.s09/drills/d.choose_raise_bridge_value.json': {
          ...
          'feedback_incorrect_v1': <String>['value behind', 'weaker continues'],
        },
      };
      ...
      for (final entry in expectations.entries) {
        ...
        expect(feedbackCorrect, isNot('Correct.'), reason: '${entry.key} should avoid generic positive feedback.');
        expect(feedbackIncorrect, isNot('Incorrect.'), reason: '${entry.key} should avoid generic corrective feedback.');
        expect(
          feedbackIncorrect,
          isNot(feedbackCorrect),
          reason: '${entry.key} corrective feedback should not duplicate positive feedback.',
        );
        ...
        for (final fieldEntry in entry.value.entries) {
          ...
          for (final banned in bannedPhrases) {
            expect(
              ...
              reason: '${entry.key} ${fieldEntry.key} should avoid corridor-internal shorthand.',
            );
          }
        }
      }
