    ...
    () {
      ...
      final expectations = <String, Map<String, List<String>>>{
        'content/worlds/world2/v1/sessions/w2.s08/drills/d.choose_raise_flop_sequence_start.json': {
          'why_v1': <String>['taking initiative', 'free card', 'passive call'],
          'feedback_correct_v1': <String>['taking initiative', 'free card', 'passive call'],
          'feedback_incorrect_v1': <String>['gives up the initiative', 'apply pressure first', 'raise'],
        },
        'content/worlds/world2/v1/sessions/w2.s08/drills/d.choose_call_turn_sequence_control.json': {
          ...
          'feedback_correct_v1': <String>['pot-control spot', 'forcing another bet'],
          'feedback_incorrect_v1': <String>['pushes past the hand', 'pot manageable', 'turn'],
        },
        'content/worlds/world2/v1/sessions/w2.s08/drills/d.choose_raise_turn_sequence_continue.json': {
          'why_v1': <String>['turn still favors pressure', 'weaker continues under strain'],
          'feedback_correct_v1': <String>['turn still favors pressure', 'weaker continues under strain'],
          'feedback_incorrect_v1': <String>['backs off too early', 'another bet', 'weaker continues under strain'],
        },
        'content/worlds/world2/v1/sessions/w2.s08/drills/d.choose_call_river_sequence_showdown.json': {
          ...
          'feedback_correct_v1': <String>['showdown value', 'cleaner than bluffing'],
          'feedback_incorrect_v1': <String>['turns showdown value into a bluff', 'finished by checking'],
        },
        'content/worlds/world2/v1/sessions/w2.s08/drills/d.choose_raise_river_sequence_value.json': {
          'why_v1': <String>['strong enough to value bet', 'leave money behind', 'worse calls'],
          'feedback_correct_v1': <String>['strong enough to value bet', 'leave money behind', 'worse calls'],
          'feedback_incorrect_v1': <String>['Checking leaves value behind', 'bet', 'worse hands'],
        },
      };
        ...
        for (final fieldEntry in entry.value.entries) {
          ...
          for (final snippet in fieldEntry.value) {
            expect(
              value,
              contains(snippet),
              reason: '${entry.key} ${fieldEntry.key} should express the same poker reason.',
            );
          }
          for (final banned in bannedPhrases) {
            expect(
              ...
              reason: '${entry.key} ${fieldEntry.key} should avoid branch/node shorthand.',
            );
          }
        }
      }
