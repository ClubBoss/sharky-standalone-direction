...
void main() {
  test(
    'active readiness authority chain points to the project readiness ssot',
    () {
      ...
      expect(
        ...
        isNot(
          contains(
            'This document defines the only valid meaning of release readiness for the product.',
          ),
        ),
      );
    },
