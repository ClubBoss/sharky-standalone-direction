...
void main() {
  ...
  testWidgets(
    'w6.s05 surfaces authored river-polarization drills without placeholder residue',
    (tester) async {
      addTearDown(() {
      ...
      final drills = (await tester.runAsync(
        () => const DrillRuntimeAdapterV1().loadSessionDrills('w6.s05'),
      ))!;
      ...
      expect(
        ...
        equals(const <String>[
          'find_bb_river_polar',
          'find_sb_river_polar',
          'tap_flop_river_polar',
          'tap_turn_reference',
          'tap_river_polar',
          'tap_hole_right_polar',
          'choose_fold_merged',
          'choose_raise_polar',
        ]),
      );
      ...
      expect(find.text('River polarization setup: tap BB.'), findsOneWidget);
