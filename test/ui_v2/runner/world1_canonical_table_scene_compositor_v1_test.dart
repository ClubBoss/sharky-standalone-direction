...
void main() {
  testWidgets('world1 canonical table scene compositor mounts major scene layers',
      (tester) async {
    final handVisualCluster = resolveWorld1CanonicalHandVisualClusterContractV1(
