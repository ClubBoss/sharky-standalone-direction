...
void main() {
  testWidgets(
    'phase2 canonical launcher enters the canonical terminal surface with canonical host launch',
    (tester) async {
      await tester.pumpWidget(
        const MaterialApp(home: CanonicalLauncherV1.phase2()),
      );
      ...
      expect(find.text('Phase 2 Runner'), findsOneWidget);
