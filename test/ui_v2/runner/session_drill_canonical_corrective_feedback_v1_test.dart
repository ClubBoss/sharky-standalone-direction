...
void main() {
  ...
  test(
    'canonical corrective feedback upgrades compact spatial and action drill families',
    () {
      ...
      expect(
        actionChoiceFeedback.whyText,
        contains('Raising turns this medium-strength hand into a thin bluff.'),
      );
      expect(actionChoiceFeedback.whyText, contains('Next time:'));

      final betSizingFeedback =
          resolveSessionDrillCanonicalCorrectiveFeedbackV1(
            sessionId: 'cash.s05',
            spec: betSizingSpec,
            isFail: true,
      ...
      expect(
        ...
        contains(
          'Raise now to build value while strong hands can still get called.',
        ),
      );
    },
  );
  ...
  test(
    'canonical corrective feedback upgrades the active world1/world6 hand-chain cluster',
    () {
      ...
      final world1PresetFeedback =
          resolveSessionDrillCanonicalCorrectiveFeedbackV1(
            sessionId: 'w1.s01',
            spec: world1PresetHandChainSpec,
            isFail: true,
            currentHandChainStepV1:
                world1PresetHandChainSpec.chainStepsV1!.first,
