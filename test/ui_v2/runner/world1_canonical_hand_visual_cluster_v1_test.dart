...
void main() {
  ...
  testWidgets('world1 canonical hand visual cluster renders board and pot bodies', (
    tester,
  ) async {
    final resolved = resolveWorld1CanonicalHandVisualClusterContractV1(
      showCampaignHandVisuals: true,
    ...
    expect(find.byKey(const Key('microtask_demo_hero_cards_box_v1')), findsOneWidget);
  });
}
