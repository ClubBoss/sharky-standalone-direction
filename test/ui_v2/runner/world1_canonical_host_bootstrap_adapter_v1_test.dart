...
void main() {
  ...
  test('world1 checkpoint bootstrap resolves seeded steps and clamps index', () async {
    ...
    expect(
      resolved.steps.every((step) => step.instructionText == 'Checkpoint cue'),
      isTrue,
    );
  });

  test('world1 review bootstrap returns sorted queued indices and pop fallback', () async {
  ...
  test('world1 campaign bootstrap resolves step index and fallback persistence', () async {
