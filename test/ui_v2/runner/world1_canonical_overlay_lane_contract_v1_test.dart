...
void main() {
  test('world1 canonical overlay lane contract resolves caption coexistence', () {
    ...
    expect(resolved.feltCaptionTop, greaterThanOrEqualTo(resolved.overlayLaneRect.top));
    expect(resolved.handLoopPromptTopBand, isNotNull);
    expect(resolved.feltCaptionLeft, lessThan(resolved.feltCaptionRight));
  });

  test('world1 canonical overlay lane contract clamps demo caption above hero cards', () {
    final resolved = resolveWorld1CanonicalOverlayLaneContractV1(
      World1CanonicalOverlayLaneContractInputV1(
