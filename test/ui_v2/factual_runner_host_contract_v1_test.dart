...
void main() {
  test(
    'factual host contract keeps behavior unchanged when supplements are absent',
    () {
  ...
  test('factual host contract accepts canonical surfaced supplement cards', () {
    ...
    expect(
      contract.recapSupplementCards.single.title,
      'Rule of 2 and 4 is approximate',
    );
  });

  test(
    'legacy factual host builder stays compatible when supplements are absent',
    () {
