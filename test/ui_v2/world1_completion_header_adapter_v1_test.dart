...
void main() {
  test(
    'world1 completion header adapter uses shared section vocabulary',
    () {
      ...
      expect(
        adapter.shouldShowOutcomeStatus(outcomeVisible: true),
        isTrue,
      );
      expect(
        adapter.shouldShowOutcomeStatus(outcomeVisible: false),
        isFalse,
      );
    },
  );
