...
void main() {
  ...
  testWidgets(
    'map campaign World 2 launch normalizes to the direct session runtime',
    (tester) async {
      ...
      mapState.debugLaunchCampaignPackForTestV1('world2_spine_campaign_v1');
      await tester.pump();
  ...
  testWidgets(
    'map world2 followup launch also normalizes to the direct session runtime',
    (tester) async {
      SharedPreferences.setMockInitialValues(<String, Object>{
        'onboardingCompleted': true,
        'intake_completed_v1': true,
      ...
      final mapState =
          tester.state(find.byType(UiV2ProgressMapScreenV2)) as dynamic;
      mapState.debugLaunchCampaignPackForTestV1('world2_spine_followup_v1_b2');
      await tester.pump();
