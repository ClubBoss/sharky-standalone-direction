...
void main() {
  test(
    'recommendation widget cluster keeps legacy launcher ownership explicit',
    () {
      ...
      expect(
        recommenderBanner.contains('await TrainingSessionLauncher().launch(pack);'),
        isTrue,
        reason:
      ...
      expect(
        recommenderBanner.contains('world1_foundations_microtask_runner_screen.dart'),
        isFalse,
        reason:
