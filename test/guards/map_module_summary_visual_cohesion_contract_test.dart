...
void main() {
  ...
  testWidgets(
    'map and module summary cohort expose premium cohesion surfaces',
    (tester) async {
      ...
      expect(
        find.byKey(const Key('module_summary_hero_card_v1')),
        findsOneWidget,
      );
      expect(
        find.byKey(const Key('module_summary_tier_pill_v1')),
        findsOneWidget,
      );
      expect(
        find.byKey(const Key('module_summary_metadata_v1')),
        findsOneWidget,
      );
    },
  );
