...
void main() {
  test('W12 fixture projects six source-owned reps with route admission', () {
    ...
    expect(
      ...
      reason: 'Projection must coexist with admitted W12 route packs.',
    );
    expect(
      kCampaignPackIdsV1.where((id) => id.startsWith('world13_')),
      isEmpty,
      reason: 'Projection must not add a W13 campaign registration.',
    );
