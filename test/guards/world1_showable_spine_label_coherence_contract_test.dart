...
void main() {
  test('showable World 1 spine labels stay coherent across the shared seam', () {
    ...
    expect(recommendedModuleTitleForId('world1_spine_campaign_v1'), 'Campaign spine');
    expect(recommendedModuleTitleForId('world1_spine_campaign_v1'), isNot('Campaign Spine v1'));
  });
}
