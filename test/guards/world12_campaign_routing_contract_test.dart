...
void main() {
  ...
  testWidgets('world12 canonical entry remains actionable on small portrait', (
    tester,
  ) async {
    addTearDown(() {
    ...
    SharedPreferences.setMockInitialValues(<String, Object>{
      ...
      'spine_campaign_completed_packs_v1':
          'world1_act0_table_literacy,world1_act0_action_literacy,world1_act0_street_flow,world1_spine_campaign_v1,world1_spine_followup_v1_b2,world2_spine_followup_v1_b2,world3_spine_followup_v1_b2,world4_spine_followup_v1_b2,world5_spine_followup_v1_b2,world6_spine_followup_v1_b2,world7_spine_followup_v1_b2,world8_spine_followup_v1_b2,world9_spine_followup_v1_b2,world10_spine_followup_v1_b2,world11_spine_followup_v1_b2',
  ...
  testWidgets('world12 routing is admitted by active learner route gate', (
    tester,
  ) async {
    SharedPreferences.setMockInitialValues(<String, Object>{
      'onboardingCompleted': true,
    ...
    expect(expectedPackId, 'world12_spine_campaign_v1');
    ...
    expect(find.textContaining('world12_spine_campaign_v1'), findsNothing);
    expect(tester.takeException(), isNull);
  });
}
