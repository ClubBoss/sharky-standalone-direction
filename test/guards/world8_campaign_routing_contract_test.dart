...
void main() {
  ...
  testWidgets('world8 entry remains actionable on small portrait', (
    tester,
  ) async {
    addTearDown(() {
    ...
    SharedPreferences.setMockInitialValues(<String, Object>{
      ...
      'spine_campaign_completed_packs_v1':
          'world1_act0_table_literacy,world1_act0_action_literacy,world1_act0_street_flow,world1_spine_campaign_v1,world1_spine_followup_v1_b2,world2_spine_followup_v1_b2,world3_spine_followup_v1_b2,world4_spine_followup_v1_b2,world5_spine_followup_v1_b2,world6_spine_followup_v1_b2,world7_spine_followup_v1_b2',
    ...
    final world8Entry = find.byKey(const Key('world_campaign_open_8'));
    ...
    expect(
      world8Entry.evaluate().isNotEmpty ||
    ...
    } else if (world8Entry.evaluate().isNotEmpty) {
      final entryRect = tester.getRect(world8Entry);
      final logicalHeight =
          tester.view.physicalSize.height / tester.view.devicePixelRatio;
  ...
  testWidgets('world8 routing selects world8 as the next deterministic pack', (
    tester,
  ) async {
    SharedPreferences.setMockInitialValues(<String, Object>{
      'onboardingCompleted': true,
    ...
    expect(find.textContaining('world8_spine_campaign_v1'), findsNothing);
    expect(tester.takeException(), isNull);
  });
}
