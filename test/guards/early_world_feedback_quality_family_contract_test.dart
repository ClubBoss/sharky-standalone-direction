...
void main() {
  ...
  test(
    'world2 outs, world2 review, world1/world3 hand-chain, and world6 range families use canonical corrective feedback',
    () {
      ...
      expect(
        outsFeedback.detailText,
        'Better answer: 9 outs. 8 misses this scene.',
      );
  ...
  test(
    'canonical corrective feedback admits the compact session explanation cluster',
    () {
      ...
      expect(
        correctiveSource,
        contains('case DrillKindV1.rangeBucketClassifier:'),
      );
      expect(
        correctiveSource,
