...
void main() {
  ...
  testWidgets('world11 canonical entry remains actionable on small portrait', (
    tester,
  ) async {
    addTearDown(() {
  ...
  testWidgets('world11 routing is admitted by active learner route gate', (
    tester,
  ) async {
    SharedPreferences.setMockInitialValues(<String, Object>{
      'onboardingCompleted': true,
    ...
    expect(expectedPackId, 'world11_spine_campaign_v1');
    ...
    expect(find.textContaining('world11_spine_campaign_v1'), findsNothing);
    expect(tester.takeException(), isNull);
  });
}
