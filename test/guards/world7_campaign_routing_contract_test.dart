...
void main() {
  ...
  testWidgets('world7 entry remains actionable on small portrait', (
    tester,
  ) async {
    addTearDown(() {
    ...
    SharedPreferences.setMockInitialValues(<String, Object>{
      ...
      'spine_campaign_completed_packs_v1':
          'world1_act0_table_literacy,world1_act0_action_literacy,world1_act0_street_flow,world1_spine_campaign_v1,world1_spine_followup_v1_b2,world2_spine_followup_v1_b2,world3_spine_followup_v1_b2,world4_spine_followup_v1_b2,world5_spine_followup_v1_b2,world6_spine_followup_v1_b2',
    ...
    expect(
      world7Entry.evaluate().isNotEmpty ||
    ...
    } else if (world7Entry.evaluate().isNotEmpty) {
      final entryRect = tester.getRect(world7Entry);
      final logicalHeight =
          tester.view.physicalSize.height / tester.view.devicePixelRatio;
