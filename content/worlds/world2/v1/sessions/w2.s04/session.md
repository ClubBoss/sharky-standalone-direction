...
## Objective
Build the next World 2 bridge by classifying simple board texture: calmer boards versus pressure-building boards.
...
## Explanation
This bridge teaches that not all flops create the same tension.
Learners should feel when a board stays stable versus when draws and pressure start to matter.
