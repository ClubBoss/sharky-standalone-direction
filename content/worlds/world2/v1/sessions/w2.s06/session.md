...
Choose the clean outs number that matches the draw.

## Explanation
This bridge turns board texture into concrete improvement counting.
It prepares the next step into later odds and pressure work without jumping into math too early.
