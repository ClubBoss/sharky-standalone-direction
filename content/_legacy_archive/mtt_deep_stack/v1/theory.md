...
Why it matters
Antes inflate pots; deeper stacks magnify mistakes across two or three streets. The pool under-4bets, over-defends flop, then overfolds turns and scare rivers. Clean ladders (3bet_ip_9bb, 3bet_oop_12bb, 4bet_ip_21bb, 4bet_oop_24bb) plus disciplined postflop sizing convert that into chips.

Rules of thumb
- Preflop ladders: vs CO/BTN steals, use 3bet_ip_9bb. From blinds, prefer 3bet_oop_12bb over wide flats to avoid dominated multiway. Keep 4bet_ip_21bb value-lean vs tight 3-bettors; mix 4bet_oop_24bb rarely with top-end blockers.
- Flats: add IP flats with suited connectors, pairs, and Axs/Kxs. Reduce OOP flats early; fold marginal offsuit broadways.
- Squeeze policy: punish open+call with 3bet_oop_12bb (blinds) and 3bet_ip_9bb (BTN). Avoid OOP trap-calls that create bad SPR.
...
- Aggression gates: double_barrel_good on range-shifting turns after a small flop bet. triple_barrel_scare on credible scare rivers with blockers. Tag overfold_exploit where population overfolds to OOP turn pressure.
...
Mini example
70bb effective. CO opens 2.2bb, BTN 3bet_ip_9bb, CO calls. Pot ~20bb; SPR ~3.0. Flop K72r: BTN small_cbet_33 ~6.5bb to deny and keep range wide; CO calls. Turn 5x bricks: BTN half_pot_50 ~10bb (double_barrel_good) targeting underpairs and weak Kx. River A: with an ace blocker, BTN triple_barrel_scare; without, check back.
