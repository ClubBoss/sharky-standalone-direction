What it is
A turn and river barreling playbook for SRP and 3-bet pots. We keep families and sizes fixed: size_down_dry vs size_up_wet, then small_cbet_33, half_pot_50, or big_bet_75. Each decision maps to exactly one token: delay_turn, probe_turns, double_barrel_good, triple_barrel_scare, call, or fold.

Why it matters
3-bet pots have lower SPR, but position and raise risk still decide whether to press or pause. Leverage capped ranges and scare cards while avoiding spew with blocker gates and Fv50/Fv75 evidence. A fixed 33/50/75 system keeps errors low and plans reproducible under pressure.

Rules of thumb
- family first by texture. Dry flops/turns -> size_down_dry; wet/dynamic -> size_up_wet.
- Default sizes by family. Dry -> small_cbet_33; wet -> half_pot_50. Upgrade to big_bet_75 only with strong blockers and Fv75 up.
