What it is
Late registration strategy is how you enter 9-max MTTs mid-event and play from 20-45bb stacks. You weigh table draw quality, who covers whom (coverage), field tendencies, and time remaining. Your ranges, sizings, and postflop lines tighten when covered and expand when you cover weaker stacks.
...
- Entry 36-45bb: add IP flats that realize [[term:EQUITY_REALIZATION]] well. OOP still prefer 3bet_oop_12bb over dominated flats in 9-max formations.
...
+ [[term:EXPLOIT]]s: pools [[term:OVERFOLD]] turns to covering stacks; tag [[term:OVERFOLD]]_[[term:EXPLOIT]] nodes and bias pressure toward those turns.
- PKO note: coverage widens call-offs versus short large bounties; otherwise keep the same entry-band baselines.

Mini example
You late-reg with 24bb. CO opens 2.2bb; you BTN 3bet_ip_9bb (jam-proxy) leveraging [[term:BLOCKERS]] and position. CO calls. Pot ~20bb, stacks ~14bb, [[term:SPR]] ~0.7. Flop A72r: small_cbet_33 to tax broadways and [[term:DENY_EQUITY]]. Called. Turn Kx (range card): half_pot_50 as a commit step with Ax/Kx and strong draws; otherwise slow down. If you were covered, reduce preflop [[term:FREQUENCY]] and prefer fold over marginal reshoves.
