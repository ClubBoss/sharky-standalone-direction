...
- taskId: w7_ajs_btn_25bb_transfer
  status: missing
  title_en: A-J suited at 25 BB
  phase: drill
  stepKind: practice
  runner: _w7AjsButtonTwentyFiveBbRunner
  runnerPrompt_en: Real table. CO opens 2.5 BB. Hero is BTN with A-J suited at 25 BB effective.
  runnerSupport_en: Read hand, position, then notice how the shorter depth simplifies the future.
  runnerQuestion_en: What is the cleaner stack-depth read here?
  teachingStep0_title_en: Same hand, simpler shallow.
  teachingStep0_body_en: The same hand can be cleaner shallow because less stack remains to punish second-best outcomes later.
...
- taskId: w7_ajs_btn_100bb_transfer
  status: missing
  title_en: A-J suited at 100 BB
  phase: drill
  stepKind: practice
  runner: _w7AjsButtonHundredBbRunner
  runnerPrompt_en: Same spot again. CO opens 2.5 BB. Hero is BTN with A-J suited at 100 BB effective.
  runnerSupport_en: The hand did not change. The stack did.
  runnerQuestion_en: What changes when this spot becomes 100 BB deep?
  teachingStep0_title_en: Same hand, deeper caution.
  teachingStep0_body_en: Deep stacks give more room, but they also punish dominated and fragile hands more because more money can keep flowing later.
  teachingStep0_title_ru:
  teachingStep0_body_ru:
  title_ru:
  runnerPrompt_ru:
...
- taskId: w7_spr_intro
  ...
  teachingStep0_body_en: SPR means stack-to-pot ratio. Low SPR leaves little room. High SPR leaves more room.
...
- taskId: w7_top_pair_spr2_transfer
  status: missing
  title_en: Top pair at SPR 2
  phase: drill
  stepKind: proveIt
  runner: _w7TopPairSprTwoRunner
  runnerPrompt_en: Real table. K-7-2 rainbow flop. Hero has K-Q and SPR is 2.
  runnerSupport_en: The hand did not change from the deeper version. Read what the low SPR changes first.
  runnerQuestion_en: What does low SPR add to this top-pair spot?
  teachingStep0_title_en: Same top pair, tighter room.
  teachingStep0_body_en: Compare this directly with the SPR 8 version. Low SPR keeps less room behind, so commitment pressure becomes part of the first read instead of a later warning.
  teachingStep0_title_ru:
  teachingStep0_body_ru:
  title_ru:
  runnerPrompt_ru:
...
- taskId: w7_top_pair_spr8_transfer
  status: missing
  title_en: Top pair at SPR 8
  phase: drill
  stepKind: practice
  runner: _w7TopPairSprEightRunner
  runnerPrompt_en: Real table. K-7-2 rainbow flop. Hero has K-Q and SPR is 8.
  runnerSupport_en: Top pair is good, but deep room keeps future-street risk alive.
  runnerQuestion_en: What does stack depth add to this top-pair spot?
  teachingStep0_title_en: Top pair is not the same at every SPR.
  teachingStep0_body_en: Read hand, board, and price first, then ask how much stack is still behind. High SPR keeps more room and more ways to make a costly mistake.
  teachingStep0_title_ru:
  teachingStep0_body_ru:
  title_ru:
  runnerPrompt_ru:
