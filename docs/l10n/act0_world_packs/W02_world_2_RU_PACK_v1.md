...
- Lessons: 6/6
- Tasks: 12/35
- Runner prompts: 12/34
- Runner supports: 12/34
- Runner questions: 12/34
- Teaching step titles: 1/34
- Teaching step bodies: 1/34
...
title_ru: Дисциплина фолда
subtitle_ru: Слабые руки часто экономят фишки именно пасом.
...
title_ru: Слабый туз под вопросом
subtitle_ru: Знакомая рука всё ещё может быть доминирована.
...
- taskId: w3_strong_continue
  ...
  runnerPrompt_en: HJ opened. Hero is BTN with KQo.
  runnerSupport_en: One seat earlier from the opener still leaves hero in position with a playable broadway.
  runnerQuestion_en: What is the simple continue?
  teachingStep0_title_en: Playable broadway, tighter opener.
  teachingStep0_body_en: KQo still continues in position, but the opener seat is one step tighter now.
...
- taskId: weak_ace_kicker_compare
  ...
  runnerPrompt_en: CO opened. Hero is BTN with KQo instead of A7o.
  runnerSupport_en: Same seat, different hand class, much less domination risk.
  runnerQuestion_en: Why is KQo the cleaner continue?
  teachingStep0_title_en: Compare the hand class.
  teachingStep0_body_en: KQo still has broadway strength, while A7o runs into stronger aces too often.
  teachingStep0_title_ru: Играбельно и в позиции.
...
subtitle_ru: Отделяй чистое продолжение от пустой надежды.
...
- taskId: apply_intro
  ...
  teachingStep0_title_ru: Группа руки, место, ситуация.
  teachingStep0_body_ru: Сначала назови группу руки и посмотри на место. Затем прочитай ситуацию за столом.
...
title_ru: Проверка дисциплины рук
subtitle_ru: Сначала группа руки, потом защита стека.
...
- taskId: checkpoint_borderline_continue
  ...
  runnerPrompt_en: CO opened. Hero is BTN with QJs.
  runnerSupport_en: Playable suited broadways can continue, but the reason is still seat plus hand class.
  runnerQuestion_en: What is the simple continue?
  teachingStep0_title_en: Borderline but playable.
  teachingStep0_body_en: QJs still continues from the Button because position and playability line up cleanly.
  teachingStep0_title_ru: Играбельно и в позиции.
