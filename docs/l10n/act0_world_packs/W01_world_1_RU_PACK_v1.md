...
- taskId: first_table_guide_one_clear_choice
  ...
  teachingStep0_title_ru: Достаточно одного ответа.
  teachingStep0_body_ru: Тебе не нужно писать сложные объяснения. Просто изучи ситуацию, сделай выбор, а затем сопоставь его с логикой решения.
  title_ru: Сделай один выбор
  summary_ru: Ответь один раз в простой ситуации для новичка, а затем разберись в логике решения.
  runnerPrompt_ru: Одного понятного решения для новичка достаточно, чтобы понять первый цикл обучения.
  runnerSupport_ru: Прочитай ситуацию, сделай один выбор и посмотри объяснение.
  runnerQuestion_ru: Выбери своё первое действие.
...
- taskId: first_table_guide_route_roles
  ...
  teachingStep0_title_ru: Запомни пять задач.
  teachingStep0_body_ru: «Главная» показывает следующий шаг. «Обучение» открывает весь маршрут. «Практика» даёт новые тренировки. «Разбор» исправляет ошибки. «Профиль» показывает успехи и настройки.
  title_ru: Куда идти дальше
  summary_ru: Разберись, за что отвечают вкладки Главная, Обучение, Практика, Разбор и Профиль.
  runnerPrompt_ru: Каждый раздел приложения выполняет свою важную задачу.
  runnerSupport_ru: Раздел «Разбор» помогает исправить ошибки, остальные вкладки ведут тебя по маршруту.
  runnerQuestion_ru: Куда нужно зайти, чтобы исправить сделанные ошибки?
...
title_ru: Что такое покер
subtitle_ru: Как банк, фолды и шоудаун определяют исход раздачи.
...
- taskId: what_poker_is_pot_stack
  ...
  teachingStep0_title_ru: Правила Холдема
  teachingStep0_body_ru: На старте ты получаешь 2 карманные карты, а на стол могут выдать до 5 общих карт. В конце раздачи (на шоудауне) побеждает лучшая комбинация из 5 карт.
  ...
  teachingStep1_title_ru: Начнём с кэш-игры
  teachingStep1_body_ru: Мы начинаем с основ кэш-игры: здесь карты, позиции, банк и логика действий не меняются от раздачи к раздаче. Турнирное давление разберём позже.
  ...
  teachingStep2_title_ru: Банк и стек — это разное
  teachingStep2_body_ru: Банк собирается в центре стола, а твой стек всегда остаётся перед тобой, за твоим местом.
...
- taskId: what_poker_is_win_ways
  ...
  teachingStep0_title_ru: Два пути к победе
  teachingStep0_body_ru: Раздача заканчивается одним из двух способов: либо все соперники сбрасывают карты (фолдят), либо оставшиеся игроки сравнивают комбинации на шоудауне.
...
- taskId: what_poker_is_showdown_win
  ...
  teachingStep0_title_ru: Суть шоудауна
  teachingStep0_body_ru: Если после всех кругов торговли в игре осталось несколько участников, они открывают свои карты и сравнивают лучшие пятикарточные комбинации.
...
- taskId: what_poker_is_live_win_transfer
  ...
  teachingStep0_title_ru: Те же правила для любого стола
  teachingStep0_body_ru: Даже в реальной раздаче финал всегда один из двух: либо все сбрасывают карты, либо дело доходит до шоудауна.
  title_ru: Победа в реальной игре
  summary_ru: Перенеси понимание фолдов и шоудауна за реальный игровой стол.
  runnerPrompt_ru: Реальный стол. Ты на баттоне (BTN), блайнды поставлены, банк составляет 1.5 BB.
  runnerSupport_ru: После первого чтения стола вспомни, какими путями может завершиться эта раздача.
  runnerQuestion_ru: Что в итоге может определить победителя в этой раздаче?
...
- taskId: what_poker_is_review
  ...
  teachingStep0_title_ru: Твой чек-лист за столом
  teachingStep0_body_ru: Перед любым решением быстро проверь: где твоё место, кто твои соперники, поставлены ли блайнды и каков размер банка.
