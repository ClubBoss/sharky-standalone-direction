...
- Tasks: 0/20
- Runner prompts: 0/20
- Runner supports: 0/20
- Runner questions: 0/20
- Teaching step titles: 0/20
- Teaching step bodies: 0/20
...
- taskId: w11_trigger_small_price_continue
  status: missing
  title_en: Small-price continue
  phase: drill
  stepKind: practice
  runner: _w11TriggerSmallPriceContinueRunner
  runnerPrompt_en: Real table. CO opens, Hero calls BTN with Q-J suited. Flop comes J-7-4 rainbow. CO bets 2 BB into 8 BB at 35 BB effective.
  runnerSupport_en: Real play means combining cues, not naming one concept.
  runnerQuestion_en: What is the cleaner response?
  teachingStep0_title_en: Price plus position can support a continue.
  teachingStep0_body_en: Read seat, hand, board, and price together. A marginal made hand can continue when the price is small and position keeps control.
...
- taskId: w11_trigger_bad_price_fold
  status: missing
  title_en: Bad-price fold
  phase: drill
  stepKind: practice
  runner: _w11TriggerBadPriceFoldRunner
  runnerPrompt_en: Same hand again. Turn bricks on J-7-4-2. CO now bets 12 BB into 14 BB at 100 BB effective.
  runnerSupport_en: A good hand can still be the wrong continue at the wrong price.
  runnerQuestion_en: What is the cleaner response now?
  teachingStep0_title_en: Same hand, worse continue.
  teachingStep0_body_en: A hand can be fine at one price and wrong at another. Read the action trail and future risk before treating top pair like an auto-continue.
  teachingStep0_title_ru:
  teachingStep0_body_ru:
  title_ru:
  runnerPrompt_ru:
...
- taskId: w11_checkpoint_mixed_table_line
  status: missing
  title_en: Mixed table line
  phase: drill
  stepKind: practice
  runner: _w11CheckpointMixedTableLineRunner
  runnerPrompt_en: Real table. HJ opens 2.5 BB. Hero calls BTN with A-J suited at 30 BB effective. Flop is A-8-4 two-tone. HJ bets 5 BB into 8 BB.
  runnerSupport_en: Read seat, hand, board, price, and stack before choosing.
  runnerQuestion_en: What is the cleaner integrated response?
  teachingStep0_title_en: Real play combines cues.
  teachingStep0_body_en: Real play means combining seat, hand, board, price, and stack depth before acting. One cue alone is usually too thin.
  teachingStep0_title_ru:
  teachingStep0_body_ru:
  title_ru:
  runnerPrompt_ru:
