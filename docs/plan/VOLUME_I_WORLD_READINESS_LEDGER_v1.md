...
Reason: W1 Showdown Basics Source/Authorship Repair v1 closes the final known
Tier A source prerequisite with six W1-owned tasks and fresh foundation/L2/L3
evidence. It does not execute Human QA, prove launch safety, measure durable
learning effect, implement monetization, open W7-W12, or complete broad W1-W6
migration.
...
- W1 now owns and validates bounded hand ranking, best-5-of-7, showdown winner,
  kicker, and board-plays tie evidence without promoting W2 bridge source.
- The Tier A prerequisite chain is ready for one focused verification/local
  cleanup gate before Human QA planning; this is not permission for 9.0,
  launch, or W7-W12 opening.
