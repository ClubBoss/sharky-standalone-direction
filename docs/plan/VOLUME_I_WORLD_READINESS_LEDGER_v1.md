...
- W3 Source Ownership Remap v1 resolves the source-ownership blocker, preserves
  the two-family bounded state, and recommends bounded W3 8.0 review rather
  than another fixture.
...
- W2 now has bounded 8.0 status; W3 has two canonical families and is ready for
  a bounded W3 8.0 review gate, not a certification claim.
