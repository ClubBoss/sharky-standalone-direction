...
- W4-W5 each have two bounded route-ready canonical families, but broad W4/W5
  coverage remains mixed because bridge evidence is still bridge-limited and
  payoff/progression certification is still missing.
...
Reason: the accepted W4-W5 Canonical Coverage Expansion PR2 adds one additional
validator-backed canonical family for W4 and one for W5 while preserving bridge
negative controls. It does not move learning effect, monetization, Human QA,
launch safety, W4/W5 8.0 status, or broad W4-W6 migration.
...
- W2 and W3 now have bounded 8.0 status; W4 and W5 each have two canonical
  families but still lack W4/W5-specific payoff/progression and certification
  review. The next highest-EV step is W4-W5 Certification / Payoff Gate v1,
  not W6 canonicalization.
