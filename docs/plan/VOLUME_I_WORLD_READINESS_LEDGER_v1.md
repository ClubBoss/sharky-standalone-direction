...
- W2 and W3 now have bounded 8.0 status; W4-W6 remain bridge-limited. The next
  highest-EV step is a W4 source/title ownership remap, not W2-W6 batch canonicalization.
