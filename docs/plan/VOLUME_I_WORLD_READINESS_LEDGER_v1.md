...
- W6 remains bridge-limited and cannot be counted as canonical launch coverage.
  Its first canonical family is planned, but source repair is required before
  fixture work.
...
Reason: the accepted W6 Range Correctness Posture + Canonical Pilot Plan adds
the World Learning Outcome Guarantee scoring note and prevents unsafe W6
canonicalization. It does not create a fixture, move W6 out of bridge-limited
status, add content breadth, execute Human QA, prove launch safety, measure
learning effect, implement monetization, or migrate broad W4-W6 coverage.
...
- W2, W3, W4, and W5 now have bounded 8.0 status. The next highest-EV step is
...
- The next highest-EV step is W6 Range Bucket Source Repair Plan v1, not
  direct W6 fixture creation.
