...
- W2 now has three canonical pilot slices and a conditional certification pass,
  but remains below W2 8.0 because W2-specific payoff/progression proof, Human
  QA, and broad migration remain incomplete.
...
Reason: the accepted W2 8.0 Certification Review reduces fixture-level
correctness and claim-safety risk for the three W2 canonical families, but does
not justify W2 8.0 because W2-specific payoff/progression proof remains open.
Overall top-1 readiness remains unchanged because payoff, Human QA, learning
effect, launch safety, and broad W2 migration remain open.
...
- W2 8.0 Certification Review / Correctness-Payoff Gate v1 conditionally
  passed W2's source/schema/correctness side but blocked clean 8.0 on missing
