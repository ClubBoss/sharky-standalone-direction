...
| W4 | 5 | 4 | 2 | 6 | 5 | 4 | 6 | 7 | 6 | 0 | 7 | 7 |
| W5 | 5 | 4 | 2 | 6 | 5 | 4 | 6 | 7 | 6 | 0 | 7 | 7 |
...
- W4-W5 each have two bounded route-ready canonical families, cleared the
  fixture-level correctness/claim-safety gate, and now have technical
  payoff/progression proof, but broad W4/W5 coverage remains mixed because
  bridge evidence is still bridge-limited and bounded certification closure is
  not yet complete.
...
Reason: the accepted W4-W5 Payoff/Progression Repair closes the named
technical payoff/progression blocker for W4/W5 using existing runtime
contracts and focused tests, but it does not perform bounded certification
closure, Human QA, launch safety, learning-effect measurement, monetization,
or broad W4-W6 migration.
...
- W2 and W3 now have bounded 8.0 status; W4 and W5 each have two canonical
  families, passed the certification/payoff gate's correctness and claim-safety
  checks, and now have W4/W5-specific technical payoff/progression proof. The
  next highest-EV step is W4-W5 Bounded Certification Closure v1, not W6
  canonicalization.
