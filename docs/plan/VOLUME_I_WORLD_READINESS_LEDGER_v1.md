...
- W4-W5 each have one bounded route-ready canonical pilot, but broad W4/W5
  coverage remains mixed because bridge evidence is still bridge-limited.
- W6 remains bridge-limited and cannot be counted as canonical launch coverage.
...
- W2 and W3 now have bounded 8.0 status; W4 and W5 each have one canonical
  pilot but still lack breadth. The next highest-EV step is W4-W5 Canonical
  Coverage Expansion PR2, not certification closure or W6 canonicalization.
