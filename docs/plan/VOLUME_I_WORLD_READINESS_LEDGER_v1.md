...
- W2-W6 now each have real validator-backed bridge_or_legacy migration pilots,
  but those pilots cannot count as canonical launch coverage.
- The next bottleneck is defining the full W1 certification bar before broad
  migration, content authoring, W2-W6 realignment, or W7-W12 admission.
