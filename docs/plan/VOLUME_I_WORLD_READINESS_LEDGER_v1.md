...
- W4-W5 each have two bounded route-ready canonical families and cleared the
  fixture-level correctness/claim-safety gate, but broad W4/W5 coverage remains
  mixed because bridge evidence is still bridge-limited and W4/W5-specific
  payoff/progression repair is still missing.
...
Reason: the accepted W4-W5 Certification / Payoff Gate removes
fixture-level correctness and claim-safety uncertainty for W4/W5's bounded
two-family scope, but it does not close W4/W5-specific payoff/progression,
learning effect, monetization, Human QA, launch safety, W4/W5 8.0 status, or
broad W4-W6 migration.
...
- W2 and W3 now have bounded 8.0 status; W4 and W5 each have two canonical
  families and passed the certification/payoff gate's correctness and
  claim-safety checks, but still lack W4/W5-specific payoff/progression proof.
  The next highest-EV step is W4-W5 Payoff/Progression Repair v1, not W6
  canonicalization.
