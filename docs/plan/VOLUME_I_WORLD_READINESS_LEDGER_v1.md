...
Created: 2026-06-28.
Last refreshed: 2026-06-29 after W6 Certification / Payoff Gate v1.
...
- W6 has two narrow canonical families and passes this technical gate, but
  payoff/progression proof is still missing and broad W6 remains mixed.
...
Reason: the accepted W6 Canonical Coverage Expansion PR2 v1 creates a second
narrow W6 canonical family from repaired `w6.s02` range-width source and proves
that both canonical W6 families validate as route-ready while bridge plus
canonical evidence remains bridge-limited. It does not certify W6 as 8.0, add
payoff/progression proof, execute Human QA, prove launch safety, measure
