# QUEUE_DETERMINATION_OPS_REMAINS_TOP_v3
...
- Determination commit base:
  - `6be9f620a4c91788eb2f47287f48716bd8c643d5`
...
- `docs/release/release_owner_review_v1.md`
  - now includes the operational packet truth and generated packet outputs

- `docs/release/go_hold_rollback_truth_v1.md`
  - now includes the operational packet truth and generated packet outputs

- `docs/release/rollback_ownership_truth_v1.md`
  - now includes the operational packet truth, generated packet outputs, and
