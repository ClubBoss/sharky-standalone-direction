...
class SurfaceContainerV3 extends StatelessWidget {
  SurfaceContainerV3({super.key});
  ...
  static const StyleTokenBundleV4 _defaultTokens = StyleTokenBundleV4(
    primarySurface: Color(0xFFE0E0E0),
  ...
  Widget _buildContainer() {
    ...
    final tint = _v4Active ? V4TokenRegistry().v4SurfaceTint : 0.0;
    final contrast = _v4Active ? V4TokenRegistry().v4ContrastLevel : 1.0;
    final tintedColor = _v4Active ? _blendTint(baseColor, tint) : baseColor;
  ...
  Color _colorWithMultiplier(Color color, double multiplier) {
    final alpha = (color.a / 255.0 * multiplier).clamp(0.0, 1.0);
