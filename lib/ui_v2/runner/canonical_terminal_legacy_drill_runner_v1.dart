...
class CanonicalTerminalLegacyDrillRunnerV1 extends StatefulWidget {
  ...
  @override
  State createState() => _CanonicalTerminalLegacyDrillRunnerV1State();
}
...
class _CanonicalTerminalLegacyDrillRunnerV1State
    extends State<CanonicalTerminalLegacyDrillRunnerV1> {
  ...
  bool get _isWorld1TableFirst =>
      kWorld1CanonicalModuleOrder.contains(widget.runtimeConfigV1.moduleIdV1);

  @override
  void initState() {
    super.initState();
    final seededItemsV1 = widget.runtimeConfigV1.resolvedItemsV1.isNotEmpty
        ? widget.runtimeConfigV1.resolvedItemsV1
        : widget.debugItemsOverrideV1;
  ...
  DrillHostCapabilityContractV1 _legacyItemHostContractV1({
    ...
    return resolveDrillHostCapabilityContractV1(
      DrillHostCapabilityContractInputV1(
        sessionId: widget.runtimeConfigV1.moduleIdV1,
        spec: DrillSpecV1(
  ...
  Future<void> _loadJsonl(
    ...
    try {
      final content = await DirectLoader.loadContentFile(
        widget.runtimeConfigV1.moduleIdV1,
        fileName,
      );
      ...
      print('Missing $fileName for ${widget.runtimeConfigV1.moduleIdV1}: $e');
    }
  }
  ...
  void _advanceDrill({bool countedAsCorrect = false}) {
    ...
    if (!advanceResultV1.completesRun) {
      ...
      pushReplacementSessionResultV1<void, void>(
        ...
        moduleId: widget.runtimeConfigV1.moduleIdV1,
      );
    }
  }
  ...
  Widget build(BuildContext context) {
    final topLevelShellContractV1 = SharedLearnerTopLevelShellContractV1(
    ...
    if (_isLoading) {
      return SharedLearnerTopLevelShellV1(
        contract: topLevelShellContractV1,
        child: Center(
  ...
  ButtonStyle _optionStyle({
    ...
    final selectedColor = SharkyTokensV1.brandPrimary.withOpacity(0.2);
    ...
    final disabledColor = SharkyTokensV1.slate600.withOpacity(0.55);
    ...
    return ButtonStyle(
      ...
      backgroundColor: MaterialStateProperty.resolveWith((states) {
        ...
        if (states.contains(MaterialState.pressed)) {
          return SharkyTokensV1.surfaceCard;
        }
        return baseColor;
      }),
