class StrategyFlowBridgeV1 {
  const StrategyFlowBridgeV1({
  ...
  StrategyFlowBridgeV1.fromInputs({
  ...
  Map<String, Object> build() {
    ...
    double value =
        (seedValue * 0.2) + (envelopeValue * 0.3) + (consolidatorValue * 0.5);
    value = value.clamp(0.0, 1.0);

    final String tag = consolidatorTag.isNotEmpty
    ...
    return <String, Object>{
      'strategy_flow_bridge_v1': <String, Object>{
        'value': value,
        'tag': tag,
        'ready': true,
      },
