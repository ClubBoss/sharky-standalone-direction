...
class TableV4FinalReadinessGateV1 {
  TableV4FinalReadinessGateV1(
    this.runtimeBundle,
  ...
  final Object interactionFinalizerV4;
  ...
  Map<String, Object> asReadOnlyMap() {
    final SplayTreeMap<String, Object?> domains =
        SplayTreeMap<String, Object?>.from(<String, Object?>{
          ...
          'interaction_finalizer_v4': interactionFinalizerV4,
    ...
    return <String, Object>{
      'table_v4_final_readiness_gate_v1': <String, Object>{
        'domains': domains,
        'missing': missing,
