class ThemeAdaptiveFusionPackV1 {
  const ThemeAdaptiveFusionPackV1({
    ...
    required this.personaAdaptiveThemeBuilderV2,
  ...
  final Object personaAdaptiveThemeBuilderV2;
  ...
  Map<String, Object> asReadOnlyMap() => <String, Object>{
    ...
    'builder': personaAdaptiveThemeBuilderV2,
    'blend': personaAdaptiveThemeBlendV2,
    'proxy': personaAdaptiveThemeProxyV2,
  };
}
