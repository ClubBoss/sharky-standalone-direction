class FinalV4ActivationSurfaceV1 {
  const FinalV4ActivationSurfaceV1({
    required this.materialAppShellBindingV1,
  ...
  final Object materialAppShellBindingV1;
  ...
  Map<String, Object> asReadOnlyMap() {
    return <String, Object>{
      'material_app_shell_binding_v1': '<opaque>',
