...
/// Counter — Φ-45.0
///
/// Passive container for V4 Theme Persona Export Pack v1.
class ThemePersonaExportPackV1 {
  const ThemePersonaExportPackV1({
  ...
  Map<String, Object> asReadOnlyMap() {
    return <String, Object>{
      'cohesion_surface': '<opaque>',
      'final_surface': '<opaque>',
      'fusion_node': '<opaque>',
      ...
      'runtime_injection': '<opaque>',
      'token_resolution': '<opaque>',
      'merge': '<opaque>',
      'interaction_blend': '<opaque>',
      'preview': '<opaque>',
      'ready_gate': '<opaque>',
      'builder': '<opaque>',
      'blend': '<opaque>',
