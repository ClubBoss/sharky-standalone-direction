class ThemeLiftPreflightValidatorV1 {
  const ThemeLiftPreflightValidatorV1({
  ...
  Map<String, Object> asReadOnlyMap() => <String, Object>{
    ...
    'lift_consolidation': themeLiftConsolidationPackV1,
    'fusion_sync': themeFusionConsolidationSyncPackV1,
