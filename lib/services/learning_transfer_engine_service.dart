...
const String _adaptiveContextPath =
    '$_reportsDir/adaptive_context_summary.json';
...
class LearningTransferEngineResult {
  LearningTransferEngineResult({
    required this.adaptiveContext,
    required this.retentionKnowledge,
    required this.semanticDepth,
  });

  final _ScoreDetail adaptiveContext;
...
class LearningTransferEngineService {
  const LearningTransferEngineService();

  Future<LearningTransferEngineResult?> evaluate() async {
    final adaptiveContext = await _loadDetail(_adaptiveContextPath, const [
      'adaptive_context_index',
      'adaptive_context_score',
      'adaptive_index',
    ]);
    ...
    return LearningTransferEngineResult(
