class RCFreezeMarkerV1 {
  const RCFreezeMarkerV1(
  ...
  Map<String, Object> asReadOnlyMap() {
    ...
    final Map<String, Object> packaging = m(rcPackagingIntegrationV1Map);
    ...
    final List<String> missing = <String>[
      if (packaging.isEmpty) 'rc_packaging_integration_v1',
    ...
    return <String, Object>{
      'rc_freeze_marker_v1': <String, Object>{
        'domains': domains,
        'missing': missing,
