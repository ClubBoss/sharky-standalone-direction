Map<String, Object> buildFinalReleaseSealV1({
  required Map<String, Object> finalReleaseGateV1,
  ...
  const fallback = <String, Object>{
    'final_release_seal_v1': false,
    'seal_score': 0,
    'issues': <String>[],
    'conflict_flags': <String>[],
    'drivers': <String>['final_release_seal_safe_fallback'],
    'verdict': 'fail',
  ...
  final conflictFlags = <String>[
    ..._asciiList(finalReleaseGateV1['conflict_flags']),
  ...
  final snapshot = _orderMap(<String, Object>{
    ...
    'final_release_gate_v1': finalReleaseGateV1,
  ...
  final verdict = (conflictFlags.isEmpty && issues.isEmpty && score >= 70)
      ? 'pass'
      : 'fail';
  final ok = verdict == 'pass';

  return <String, Object>{
    'final_release_seal_v1': ok,
    'seal_score': score,
