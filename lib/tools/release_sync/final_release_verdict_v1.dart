Map<String, Object> buildFinalReleaseVerdictV1({
  ...
  const fallback = <String, Object>{
    'final_release_verdict_v1': true,
    'verdict_ok': false,
    'score': 0,
    'issues': <String>['final_release_verdict_safe_fallback'],
    'drivers': <String>['final_release_verdict_safe_fallback'],
  ...
  final score = (100 - (issues.length * 2)).clamp(0, 100);
  final verdictOk = issues.isEmpty && score >= 70;
