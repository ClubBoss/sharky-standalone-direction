Map<String, Object> buildReleaseSyncSurfaceV1({
  ...
  required Map<String, Object> token_verification_stage_final,
  required Map<String, Object> persona_v4_mat_final,
  required Map<String, Object> persona_v4_mat_consistency_stage_final,
  required Map<String, Object> final_v4_polish,
  required Map<String, Object> final_visual_polish_stage,
  ...
  required Map<String, Object> final_marketing_onboarding_sync,
  required Map<String, Object> final_marketing_onboarding_coherence_v2,
  required Map<String, Object> final_marketing_onboarding_seal,
  required Map<String, Object> final_marketing_onboarding_release_bridge,
  ...
  required Map<String, Object> final_release_assembly,
  required Map<String, Object> final_release_assembly_stability,
  required Map<String, Object> final_release_assembly_harmonization,
  required Map<String, Object> global_regression_sweep,
}) {
  ...
  const fallback = <String, Object>{
    'release_sync_surface_ok': false,
    'alignment_score': 0,
    'conflict_flags': <String>[],
    'drivers': <String>['release_sync_surface_safe_fallback'],
    'sections': <String, Object>{},
    'snapshot': <String, Object>{},
    'final_release_sync_pass_v1': <String, Object>{
      'release_sync_score': 0,
      'conflict_flags': <String>[],
      'drivers': <String>['release_sync_surface_safe_fallback'],
      'snapshot': <String, Object>{},
    },
  ...
  final inputs = [
    ...
    token_verification_stage_final,
    persona_v4_mat_final,
    persona_v4_mat_consistency_stage_final,
    final_v4_polish,
    final_visual_polish_stage,
    final_coherence_pass,
    final_visual_polish,
    final_marketing_readiness,
    final_marketing_onboarding,
    final_marketing_onboarding_coherence,
    final_marketing_onboarding_sync,
    final_marketing_onboarding_coherence_v2,
    final_marketing_onboarding_seal,
    final_marketing_onboarding_release_bridge,
    smart_pack_surface,
    regression_platform_snapshot,
    final_rpg_stability,
    final_xp_reward,
    final_release_assembly,
    final_release_assembly_stability,
    final_release_assembly_harmonization,
    global_regression_sweep,
  ];
  ...
  final conflictFlags = <String>[
    ...
    ..._asciiList(global_regression_sweep['conflict_flags'] ?? const []),
    ..._asciiList(token_verification_stage_final['conflict_flags'] ?? const []),
    ..._asciiList(
      persona_v4_mat_consistency_stage_final['conflict_flags'] ?? const [],
    ),
    ..._asciiList(final_visual_polish_stage['conflict_flags'] ?? const []),
    ..._asciiList(
      final_marketing_onboarding_sync['conflict_flags'] ?? const [],
    ),
    ..._asciiList(
      final_marketing_onboarding_coherence_v2['conflict_flags'] ?? const [],
    ),
    ..._asciiList(
      final_marketing_onboarding_seal['conflict_flags'] ?? const [],
    ),
    ..._asciiList(
      final_marketing_onboarding_release_bridge['conflict_flags'] ?? const [],
    ),
    ..._asciiList(final_release_assembly['conflict_flags'] ?? const []),
    ..._asciiList(
      final_release_assembly_stability['conflict_flags'] ?? const [],
    ),
    ..._asciiList(
      final_release_assembly_harmonization['conflict_flags'] ?? const [],
    ),
  ]..sort();
  ...
  final drivers = <String>[
    ...
    ..._asciiList(global_regression_sweep['drivers'] ?? const []),
    ..._asciiList(token_verification_stage_final['drivers'] ?? const []),
    ..._asciiList(
      persona_v4_mat_consistency_stage_final['drivers'] ?? const [],
    ),
    ..._asciiList(final_visual_polish_stage['drivers'] ?? const []),
    ..._asciiList(final_marketing_onboarding_sync['drivers'] ?? const []),
    ..._asciiList(
      final_marketing_onboarding_coherence_v2['drivers'] ?? const [],
    ),
    ..._asciiList(final_marketing_onboarding_seal['drivers'] ?? const []),
    ..._asciiList(
      final_marketing_onboarding_release_bridge['drivers'] ?? const [],
    ),
    ..._asciiList(final_release_assembly['drivers'] ?? const []),
    ..._asciiList(final_release_assembly_stability['drivers'] ?? const []),
    ..._asciiList(final_release_assembly_harmonization['drivers'] ?? const []),
    'rpg',
    'xp',
    'coaching',
    'persona',
  ...
  final sections = _orderMap(<String, Object>{
    ...
    'final_visual_polish_stage': final_visual_polish_stage,
    'final_marketing_readiness': final_marketing_readiness,
    'final_marketing_onboarding': final_marketing_onboarding,
    'final_marketing_onboarding_coherence':
        final_marketing_onboarding_coherence,
    'final_marketing_onboarding_sync': final_marketing_onboarding_sync,
    'final_marketing_onboarding_coherence_v2':
        final_marketing_onboarding_coherence_v2,
    'final_marketing_onboarding_seal': final_marketing_onboarding_seal,
    'final_marketing_onboarding_release_bridge':
        final_marketing_onboarding_release_bridge,
    ...
    'final_release_assembly': final_release_assembly,
    'final_release_assembly_stability': final_release_assembly_stability,
    'final_release_assembly_harmonization':
        final_release_assembly_harmonization,
    'global_regression_sweep': global_regression_sweep,
  });

  final snapshot = _orderMap(<String, Object>{...sections});

  final passSnapshot = _orderMap(<String, Object>{
    'release_sync_snapshot': release_sync_snapshot,
    'release_sync_surface_sections': sections,
  });
  final passConflicts = <String>[
    ...conflictFlags,
    ..._asciiList(global_regression_sweep['conflict_flags'] ?? const []),
  ]..sort();
  final passDrivers = <String>[
    ...drivers,
    ..._asciiList(global_regression_sweep['drivers'] ?? const []),
  ]..sort();

  return <String, Object>{
    'release_sync_surface_ok': ok,
    ...
    'snapshot': snapshot,
    'final_release_sync_pass_v1': <String, Object>{
      'release_sync_score': _clamp(100 - (passConflicts.length * 2)),
      'conflict_flags': List<String>.unmodifiable(passConflicts),
      'drivers': List<String>.unmodifiable(passDrivers),
