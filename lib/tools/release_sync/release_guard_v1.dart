Map<String, Object> buildReleaseGuardV1({
  ...
  const fallback = <String, Object>{
    'release_guard_ok': false,
    'alignment_score': 0,
    'conflict_flags': <String>[],
    'drivers': <String>['release_guard_safe_fallback'],
    'issues': <String>[],
  ...
  final issues = <String>[
    if ((release_sync_surface['release_sync_surface_ok'] ?? true) == false)
      'surface_not_ok',
    if ((release_sync_snapshot['release_sync_ok'] ?? true) == false)
      'snapshot_not_ok',
  ];
