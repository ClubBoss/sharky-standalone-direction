Map<String, Object> buildFinalConsistencySweepV1({
  ...
  const fallback = <String, Object>{
    'final_consistency_sweep_v1': true,
    'consistency_ok': false,
    'issues': <String>['final_consistency_sweep_safe_fallback'],
    'drivers': <String>['final_consistency_sweep_safe_fallback'],
