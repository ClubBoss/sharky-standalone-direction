class QAFinalIntegrationSurfaceV1 {
  const QAFinalIntegrationSurfaceV1(
  ...
  Map<String, Object> asReadOnlyMap() {
    ...
    final Map<String, Object> releaseSummary = m(qaReleaseSummaryV1Map);
    ...
    final List<String> missing = <String>[
      if (releaseSummary.isEmpty) 'qa_release_summary_v1',
    ...
    return <String, Object>{
      'qa_final_integration_surface_v1': <String, Object>{
        'domains': domains,
        'missing': missing,
        'surface_ready': readyFlag,
      },
      'readiness': readyFlag,
    };
  }
