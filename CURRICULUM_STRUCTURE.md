...
> Authority note:
> This file is reference curriculum material and is not the active content-planning SSOT.
> Current content/document authority starts at `docs/README_SSOT.md`.
