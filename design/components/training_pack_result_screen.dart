        ...
        children: [
          Column(
            ...
            children: [
              ...
              Text('⭐ +$xpGained XP', style: AppTypography.body),
            ],
          ),
          Column(
            crossAxisAlignment: CrossAxisAlignment.end,
            children: [
              Text('⚡ $energy/$maxEnergy Energy', style: AppTypography.body),
              const SizedBox(height: 4),
              Text(
              ...
              ValueListenableBuilder<UiPerfSnapshot>(
                ...
                builder: (context, perf, _) {
                  return Text(
                    '🧠 ${perf.fpsAvg.toStringAsFixed(1)} fps (miss ${perf.missesPerMinute.toStringAsFixed(1)}/m)',
                    style: AppTypography.caption,
                  );
                },
              ),
